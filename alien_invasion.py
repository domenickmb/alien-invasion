...
# Description: A python game using the Pygame module #
#       that mimics the classic 'Space Invader'      #
...
class AlienInvasion:
    ...
    def _update_aliens(self):
        """
        Check if the the fleet is at an edge,
    ...
    def _update_screen(self):
        ...
        if not self.stats.game_active:
            ...
            # Draw bullets only if the game is active
